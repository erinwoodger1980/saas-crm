...
export const STANDARD_FIELDS: StandardFieldDefinition[] = [
  ...
  },
  {
    ...
    type: "TEXT",
    required: false,
    helpText: "Timber type and specifications",
    placeholder: "e.g., Oak, Pine, etc.",
    sortOrder: 307,
    group: "Manufacturing",
    scope: "manufacturing",
    isStandard: true,
  },
  {
    ...
    type: "TEXT",
    required: false,
    helpText: "Glass type and specifications",
    placeholder: "e.g., Clear, Frosted, etc.",
    sortOrder: 308,
    group: "Manufacturing",
    scope: "manufacturing",
    isStandard: true,
  },
  {
    ...
    type: "TEXT",
    required: false,
    helpText: "Hardware and fittings",
    placeholder: "e.g., Handles, Hinges, Locks, etc.",
    sortOrder: 309,
    group: "Manufacturing",
    scope: "manufacturing",
    isStandard: true,
  },
  {
    ...
    type: "TEXT",
    required: false,
    helpText: "Paint color and finish",
    placeholder: "e.g., White Gloss, RAL 9016, etc.",
    sortOrder: 310,
    group: "Manufacturing",
    scope: "manufacturing",
    isStandard: true,
