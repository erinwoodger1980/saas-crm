  ...
  try {
    ...
    const doParse = async () => {
      ...
      for (const f of filesToParse) {
        ...
        const normalizedParsed = normalizedResult.normalized;
        const normalizedQuote = normalizedResult.normalizedQuote;
        const supplierFromParse = normalizedResult.supplier;
        const currencyFromParse = normalizedResult.currency;
        const parsedLines = normalizedResult.lines;
