...
async function updateWealdenLanding() {
  ...
  const landingTenant = await prisma.landingTenant.upsert({
    ...
    create: {
      ...
      homeUrl: 'https://www.wealdenjoinery.com',
      brandColor: '#8B4513', // Rich oak brown
      guarantees: [
  ...
  await prisma.landingTenantContent.upsert({
    ...
    create: {
      ...
      faqJson: JSON.stringify([
        ...
        {
          question: 'Can you match existing period windows?',
          answer: 'Yes, we specialize in make-to-match replication for period properties. Whether it\'s Victorian sash, Edwardian bay, or cottage casements, our skilled craftsmen can recreate exact matches for replacements or extensions. We pay great attention to joinery details, ironmongery, and glass to ensure authenticity.'
        },
        {
          question: 'Do you work on listed buildings?',
          answer: 'Absolutely. We have extensive experience with listed buildings and period properties. We provide expert advice on appropriate glazing and materials that meet conservation requirements while maintaining the character and integrity of your property.'
        },
        {
          question: 'What areas do you serve?',
          answer: 'We supply and fit bespoke windows and doors throughout East Sussex and Kent. All our products are handcrafted in our workshop near Rotherfield, East Sussex.'
        },
        {
          question: 'How long do your windows and doors last?',
          answer: 'Our Accoya windows come with a 50-year anti-rot guarantee and are expected to last twice as long as engineered softwood. Oak windows, when properly maintained, can last for generations. We use super prime and prime grade oak which has less shrinkage and fewer grains and knots than standard joinery grade.'
        },
        {
          question: 'What makes Wealden Joinery different?',
          answer: 'Every member of our team is City & Guilds qualified. We use only the highest quality timber (super prime oak and Accoya), source from FSC certified suppliers, and craft everything by hand in our local workshop. We take pride in our excellent on-time delivery record and keeping customers informed throughout their project.'
        }
      ]),
      leadMagnet: JSON.stringify({
        title: 'Free Guide: Choosing the Right Timber for Your Windows',
        description: 'Learn about oak vs. Accoya, period property considerations, and how to ensure your windows last a lifetime',
      }),
  ...
  console.log('\n✅ Wealden Joinery landing page content updated successfully!');
  console.log(`   View at: http://localhost:3000/tenant/wealden/landing`);
}
