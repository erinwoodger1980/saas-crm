...
import { LayoutDashboard, Mail, RadioTower, Wrench, LineChart, Code, Flame, ChevronLeft, ChevronRight, Package, Upload, Target, Users, BarChart3 } from "lucide-react";
      ...
      <aside className="bg-white border-r flex flex-col relative overflow-y-auto">
        ...
        <nav className="p-2 space-y-1 flex-1">
          ...
          {/* Coaching Hub - only for coaching members or owners */}
            ...
            {(() => {
              const shouldShow = isGroupCoachingMember;
              console.log("[AppShell] Coaching Hub visibility check:", {
                isGroupCoachingMember,
                shouldShow,
              });
              return shouldShow;
