...
/**
 * Fallback: Minimal double-hung sash window (two sashes, glazing bars).
 * Used when description clearly indicates a sash window but AI returns no components.
 */
export function createFallbackSashWindowPlan(
  widthMm: number = 1200,
  heightMm: number = 1800,
  depthMm: number = 80
): ProductPlanV1 {
  return {
    kind: 'ProductPlanV1',
    ...
    components: [
      // Box frame
      {
        ...
        role: 'FRAME_JAMB_L',
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'FRAME_JAMB', lengthExpr: 'ph' },
        transform: { xExpr: '0', yExpr: '0', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
        ...
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'FRAME_JAMB', lengthExpr: 'ph' },
        transform: { xExpr: 'pw - frameW', yExpr: '0', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
        ...
        role: 'FRAME_HEAD',
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'FRAME_JAMB', lengthExpr: 'pw' },
        transform: { xExpr: '0', yExpr: 'ph - frameW', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
      ...
      // Lower sash (simplified)
      {
        id: 'lower_stile_l',
        role: 'STILE',
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'LEAF_STILE', lengthExpr: 'sashH' },
        transform: { xExpr: 'frameW', yExpr: 'frameW', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
        ...
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'LEAF_STILE', lengthExpr: 'sashH' },
        transform: { xExpr: 'pw - frameW - sashStileW', yExpr: 'frameW', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
        ...
        role: 'RAIL_BOTTOM',
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'LEAF_RAIL', lengthExpr: 'pw - (frameW * 2)' },
        transform: { xExpr: 'frameW', yExpr: 'frameW', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
        ...
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'LEAF_RAIL', lengthExpr: 'pw - (frameW * 2)' },
        transform: { xExpr: 'frameW', yExpr: 'frameW + sashH - sashRailH', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
      ...
      },
      {
        ...
        transform: { xExpr: 'frameW + sashStileW', yExpr: 'frameW + sashRailH', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'GLASS_CLEAR',
      },

      // Upper sash (simplified)
      {
        id: 'upper_stile_l',
        role: 'STILE',
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'LEAF_STILE', lengthExpr: 'sashH' },
        transform: { xExpr: 'frameW', yExpr: 'frameW + sashH', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
        ...
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'LEAF_STILE', lengthExpr: 'sashH' },
        transform: { xExpr: 'pw - frameW - sashStileW', yExpr: 'frameW + sashH', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
      ...
      },
      {
        ...
        parametric: true,
        geometry: { type: 'profileExtrude', profileSlot: 'LEAF_RAIL', lengthExpr: 'pw - (frameW * 2)' },
        transform: { xExpr: 'frameW', yExpr: 'frameW + (sashH * 2) - sashRailH', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'TIMBER_PRIMARY',
      },
      {
      ...
      },
      {
        ...
        transform: { xExpr: 'frameW + sashStileW', yExpr: 'frameW + sashH + sashRailH', zExpr: '0', rotXDeg: 0, rotYDeg: 0, rotZDeg: 0 },
        quantityExpr: '1',
        materialRole: 'GLASS_CLEAR',
      },
    ],
    variables: {
      ...
      sashH: { defaultValue: Math.round((heightMm - 160) / 2), unit: 'mm', description: 'Approx sash height' },
    },
    rationale: 'Fallback: double-hung sash window with two glazed sashes and glazing bars',
  };
}
