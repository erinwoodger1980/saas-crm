...
export const metadata: Metadata = {
  ...
  description:
    "Since the 1990s, crafting premium timber windows and doors. Made-to-order at our Crowborough headquarters, delivered nationwide with consultation-led service.",
};
...
export default function AboutPage() {
  return <AboutContent heroImage={heroImage} storyImages={storyImages} valuesImage={valuesImage} />;
}
