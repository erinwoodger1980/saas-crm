              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <h4 className="text-sm font-semibold text-blue-900 mb-3 flex items-center">
                    ...
                    3D Model & Parametric Dimensions
                  </h4>
                  <p className="text-xs text-blue-700 mb-3">
                    For use in 3D product configurator and parametric building. Attributes tab defines which dimensions are configurable.
                  </p>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        placeholder="e.g., 114"
                        className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm bg-white focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                      />
                    </div>
                  ...
                  <div className="mt-3 text-xs text-blue-600">
                    💡 Upload 3D model (GLB/GLTF) and profiles (SVG/DXF) in the component detail view after saving
                  </div>
                </div>
