      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className={`border rounded p-3 text-left ${plan === "monthly" ? "border-black" : "border-gray-300"}`}
          >
            <div className="font-medium">Monthly</div>
            <div className="text-sm text-gray-600">£625 / mo</div>
          </button>
          <button
            type="button"
            onClick={() => setPlan("annual")}
            className={`border rounded p-3 text-left ${plan === "annual" ? "border-black" : "border-gray-300"}`}
          >
            <div className="font-medium">Annual</div>
            <div className="text-sm text-gray-600">£468.75 / mo (billed yearly)</div>
          </button>
        </div>
        <div>
