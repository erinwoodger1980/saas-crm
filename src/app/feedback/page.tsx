      ...
      <div className="flex flex-wrap items-center gap-3 justify-between">
        <div>
          ...
          <p className="text-sm text-slate-600">
            Track what early access users are seeing and mark items off as they&apos;re delivered.
          </p>
        </div>
        <Badge variant={openCount > 0 ? "default" : "secondary"} className="text-sm">
          {openCount} open
        </Badge>
      </div>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-[10rem]">Submitted by</TableHead>
          ...
          <TableBody>
            ...
            {visibleItems.map((item) => {
              ...
              return (
                <TableRow key={item.id} className={item.status === "OPEN" ? "bg-orange-50/40" : undefined}>
