...
export default function FeedbackWidget() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    e.preventDefault();
    if (!comment.trim()) {
      setError("Please add a quick note so the team knows what happened.");
      return;
    }
    ...
    <>
      <div className="fixed bottom-6 right-6 z-[60] flex items-center gap-2">
        <button
          ...
          className="rounded-full bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-lg shadow-blue-600/30 transition hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
        >
          Give feedback
        </button>
      </div>
        ...
        <DialogContent className="sm:max-w-lg">
          <form onSubmit={handleSubmit} className="space-y-4">
            <DialogHeader>
              ...
              <DialogDescription>
                Spot something that feels off? Let the product team know.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="px-5 space-y-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500">
                  Your message is shared directly with the Joinery AI team.
                </p>
              </div>
